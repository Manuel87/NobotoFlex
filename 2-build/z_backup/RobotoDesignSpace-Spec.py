...
#designSpacePath = familyName + ".designspace" #optional

#CAUTION: make sure the axes names map to the english label (uppercase and spaces are only allowed in the labelName)
...
scriptpath = "scripts/writeDesignSpace.py"
